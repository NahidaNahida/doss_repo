...
version_dict = {
    'v1': LinearAmplitudeFunction_defect1, 
    'v2': LinearAmplitudeFunction_defect2,
    'v3': LinearAmplitudeFunction_defect3,
    'v4': LinearAmplitudeFunction_defect4,
    'v5': LinearAmplitudeFunction_defect5
}
