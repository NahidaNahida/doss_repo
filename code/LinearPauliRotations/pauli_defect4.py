...
from qiskit.circuit.library import FunctionalPauliRotations


class LinearPauliRotations_defect4(FunctionalPauliRotations):
    ...
    def _build(self):
        ...
        for i, q_i in enumerate(qr_state):                     
            if self.basis == "x":
                ...
                circuit.cry(self.slope * pow(2, i-1), q_i, qr_target)       # defects 2
            else:  # 'Z'
