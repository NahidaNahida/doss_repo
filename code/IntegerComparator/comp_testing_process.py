...
version_dict = {
    'v1': IntegerComparator_defect1, 
    'v2': IntegerComparator_defect2,
    'v3': IntegerComparator_defect3,
    'v4': IntegerComparator_defect4,
    'v5': IntegerComparator_defect5
}
...
def testing_with_statistic(
    ...
    for test_order in range(len(df)): 
        ...
        qc = qc_initial.copy()
        qc_test = version_dict[program_version](input_qubits, L, sign)
...
def testing_with_doss(
    ...
    for test_order in range(len(df)): 
        ...
        expected_val = program_specification_value(input_qubits, number, L, sign)
